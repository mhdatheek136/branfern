...
export default {
    ...
    fields: [
        ...
        // SEO
        {
            ...
            title: 'SEO Title',
            type: 'string',
            description: 'Override the browser tab title. Defaults to Project Name. (Max 60 chars)',
            group: 'seo'
        },
        {
            name: 'seoDescription',
            ...
            type: 'text',
            rows: 3,
            description: 'Description for search engines and social shares. Defaults to Short Description. (Max 160 chars)',
            group: 'seo'
        },
        {
            name: 'seoImage',
            ...
            type: 'image',
            description: 'Image used for social sharing cards. Defaults to Main Image.',
            group: 'seo'
        }
    ],
    preview: {
